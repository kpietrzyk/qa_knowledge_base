...
Gdy nie masz fizycznej farmy urządzeń, a musisz sprawdzić kompatybilność.
...
Uruchom smoke test na kilku popularnych modelach Android.
...
```text
Jesteś seniorem QA Mobile. Naucz mnie narzędzia Firebase Test Lab praktycznie.

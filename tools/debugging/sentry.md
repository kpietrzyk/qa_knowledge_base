...
Gdy błędy produkcyjne i testowe muszą trafiać do zespołu z kontekstem technicznym.
...
Połącz eventy z wersją aplikacji i zgłoszeniami w Jira.
...
```text
Jesteś seniorem QA Mobile. Naucz mnie narzędzia Sentry praktycznie.

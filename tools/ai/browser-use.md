...
Gdy chcesz automatyzować działania w przeglądarce przy pomocy LLM.

## Najlepsze zastosowania

- AI browser agents
- automatyzacja procesów web
- eksploracja paneli
...
```text
Jesteś seniorem QA Mobile. Naucz mnie narzędzia Browser Use praktycznie.

...
- Podkategoria: `mcp-web-automation`
- Darmowe: `True`
...
Gdy chcesz, aby AI mogło sterować przeglądarką i pomagać w testach webowych.
...
Połącz z Claude/Cursor/innym klientem MCP i zacznij od panelu testowego.
...
```text
Jesteś seniorem QA Mobile. Naucz mnie narzędzia Playwright MCP praktycznie.

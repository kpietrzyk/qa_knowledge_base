...
Gdy chcesz widzieć rzeczywiste crashe z testów i produkcji.
...
Łącz zgłoszenia z Jira i wersjami buildów.
...
```text
Jesteś seniorem QA Mobile. Naucz mnie narzędzia Firebase Crashlytics praktycznie.
